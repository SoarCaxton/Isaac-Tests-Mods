...
# 读取 JSON 数据
with open("save1.dat", "r", encoding="utf-8") as f:
    data = json.load(f)
...
# 将0替换为NaN以便在mean时跳过，skipna=True 默认会跳过 NaN
...
# -------- 保存到 Excel --------
with pd.ExcelWriter("experiment_results.xlsx", engine="xlsxwriter") as writer:
