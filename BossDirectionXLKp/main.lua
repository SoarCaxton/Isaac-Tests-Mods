local mod = RegisterMod("Boss Direction XL with Knife Piece 1", 1)
...
mod:AddCallback(ModCallbacks.MC_POST_GAME_STARTED, function(self, isContinued)
    ...
    Isaac.GetPlayer():AddCollectible(CollectibleType.COLLECTIBLE_KNIFE_PIECE_1)
end)
