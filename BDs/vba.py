...
import path   # 从 config.py 读取目标目录路径
...
Sub BatchSaveAsMHTRecursive()
    ...
    Print #f, "<html><head><meta charset='utf-8'><title>Excel 2 MHT</title></head><body>"
    Print #f, "<h1>Excel 2 MHT</h1>"
    ...
    For Each file In f.Files
        If LCase(Right(file.Name, 5)) = ".xlsx" Then
            If Left(file.Name, 2) <> "~$" Then
                ...
                relPath = Replace(relPath, ".xlsx", ".mht")
